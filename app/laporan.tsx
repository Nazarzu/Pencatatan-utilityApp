        ...
        <View className='flex-1'>
            <ImageBackground source={require("../assets/images/RS.jpg")} className="absolute w-full h-full" resizeMode="cover">
                <SafeAreaView className="flex-1 px-6 py-6">
                            ...
                            <View className="mt-8">
                                <Link href="/SeeLoglist" className="bg-white rounded-md font-inter-bold text-lg">
                                    ...
                                    <View className="flex-row items-center">
                                        ...
                                        <Text className="text-lg font-medium text-gray-700 ml-4 mr-2">Input Loglist</Text>
                                ...
                                <Link href="/loglist" className="bg-white mt-5 rounded-md font-inter-bold text-lg">
                                    <View className="flex-row items-center justify-between w-full pr-2">
                                        <View className="flex-row items-center">
                                            ...
                                            <Text className="text-lg font-medium text-gray-700 ml-4 mr-2">Lihat Loglist</Text>
                    ...
                    <Link href="/" className="bg-gray-700 rounded py-2 text-white font-bold text-lg text-center w-full">HOME</Link>
                </SafeAreaView>
            </ImageBackground>
        </View>
    );
