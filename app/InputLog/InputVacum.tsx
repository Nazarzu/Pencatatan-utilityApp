...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzh_0xAT-Uz15Tz_HLAAnuWmURj9XUXad-ihrr6l6UEUvnymfn9llO5GiHTBwRTBoMv/exec";
                    ...
                    <ScrollView contentContainerStyle={{ padding: 14 }}>
                        ...
                        <View className="px-6 py-8 bg-white rounded-md shadow-md">
                            ...
                            <View className="flex-row gap-1 items-center mb-3">
                                <Text>Pressure gauge {!pressure && <Text className="text-red-500">*</Text>}</Text>
                            </View>
