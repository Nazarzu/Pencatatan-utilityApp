...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycby8gA5hKph2Z4Njsp50EbkZi4fLsUEfP6L19Z_GqH82TayuFMocGr0zUHKwrHlycDVtHA/exec";
...
const InputCO2 = () => {
    ...
    const handleSubmit = async () => {
        ...
        if( !isi || !kosong || !preasure || !petugasFinal) {
            return Alert.alert("Harap isi semua kolom yang wajib (*).");
        }
        setLoading(true);
        try {
            const payload = { isi, kosong, preasure, keterangan, petugas: petugasFinal, api_key: "api_key_20251010_4f8c2e9b7a1d4c6e8f3a0b2d9e7c5a1f6b3d8c2e9f0a4b6d7c1e3f9a0b2d4c6"};
            ...
            if (json.status === "success") {
                ...
                setIsi(""); setKosong(""); setPreasure(""); setKeterangan(""); setPetugas(""); setLainnya(""); setShowLainnyaInput(false);
            } else {
                ...
                <KeyboardAwareScrollView extraScrollHeight={80} enableOnAndroid={true} keyboardOpeningTime={0} scrollEnabled={true} className="flex-1">
                    <ScrollView contentContainerStyle={{ padding: 14 }}>
                        ...
                        <View className="px-6 py-8 bg-white rounded-md shadow-md">
                            <Text className="text-xl font-bold mb-4">Form Pencatatan CO2</Text>
