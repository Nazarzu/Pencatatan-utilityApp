        ...
        const fetchData = async () => {
            try {
                ...
                if (!json.table || !json.table.cols) {
                    ...
                    const defaultHeaders = ["Status Genset 60 Kva", "Accu Voltage", "Level Air Accu Genset", "Level Oil Genset", 
                                            "Level air Radiator Genset", "Stok solar / max 50L", "Hour Meter", "Keterangan", "Petugas", "Timestamp"];
            ...
            <SafeAreaView className="flex-1 p-4 bg-gray-100">
                <ScrollView className="mb-4">
                    ...
                    <View className="px-6 py-8 bg-white  shadow-md rounded-md">
                        <Text className="text-lg font-bold">Data Genset 60 Kva</Text>
                        <ScrollView horizontal className="mt-4">
                            <View className="">
                                <View className="flex-row bg-gray-200 rounded-t-md">
                                    ...
                                    <Text className="px-5 py-4 font-medium w-52 text-left">Stok solar / max 50L</Text>
