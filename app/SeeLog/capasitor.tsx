    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const sheetId = "1IrPyx7UYxPdyAc2GCJq7jnGOf-Cqvv6x_-8Gae7_b18";
                ...
                if (!json.table || !json.table.cols) {
                    ...
                    const defaultHeaders = ["Status", "Cos", "Keterangan", "Petugas", "Timestamp"];
            ...
            <SafeAreaView className="flex-1 p-4 bg-gray-100">
                <ScrollView className="mb-4">
                    ...
                    <View className="px-6 py-8 bg-white  shadow-md rounded-md">
                        <Text className="text-lg font-bold">Data Capasitor Bank</Text>
                        <ScrollView horizontal className="mt-4">
                            <View className="">
                                <View className="flex-row bg-gray-200 rounded-t-md">
                                    <Text className="px-5 py-4 font-medium w-36 text-left">Status</Text>
                                    <Text className="px-5 py-4 font-medium w-52 text-left">Cos Phi (Faktor daya)</Text>
                                ...
                                <ScrollView>
                                    {data.length === 0 ? (
                                        ...
                                        <View key={index} className="flex-row border border-t-0 border-gray-100">
                                            ...
                                            <Text className="px-5 py-4 w-52 text-justify">{item.Cos}</Text>
