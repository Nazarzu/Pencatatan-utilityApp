        ...
        const fetchData = async () => {
            try {
                ...
                if (!json.table || !json.table.cols) {
                    ...
                    const defaultHeaders = ["Status Pompa Deepwell 3", "Stand meter awal", "Stand meter akhir", "Keterangan", "Petugas", "Timestamp"];
                ...
                const formattedData = rows.map((item: any) => ({
                    Status: item["Status Pompa Deepwell 3"] ?? "",
            ...
            <SafeAreaView className="flex-1 p-4 bg-gray-100">
                <ScrollView className="mb-4">
                    ...
                    <View className="px-6 py-8 bg-white  shadow-md rounded-md">
                        <Text className="text-lg font-bold">Data Deepwell 3</Text>
